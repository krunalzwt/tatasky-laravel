                ...
                <div class="leftpart">
                    ...
                    <div>
                        <form action="{{route('channels.delete')}}" method="post">
                            ...
                            <ul class="leftlist">
                                <li class="delete">
                                    <input class="floatl" name="selectAll" type="checkbox" id="selectAll" onchange="toggleAll()" />
                                ...
                                @foreach ($allChannels as $channelItem)
                                    <li>
                                        <div class="div1">
                                            <input class="checkbox floatl channel-checkbox" name="channels[]" type="checkbox" value="{{ $channelItem->id }}" />
                                        </div>
                                        <div class="div2">
                        ...
                        <form method="post" action="{{ route('channels.update', $channel->id) }}"
                            ...
                            <div style="margin-bottom: 10px;">
                                ...
                                <select style="padding: 5px;" name="number">
                                    ...
                                    @for ($i = 100; $i <= 500; $i++)
                                        <option value="{{ $i }}"
                                            @if (old('number', $channel->number) == $i) selected @endif>{{ $i }}
                                        </option>
                                    @endfor
                                </select>
                                <div class="sidetxt">It must be unique in DB.</div>
                            ...
                            <div style="margin-bottom: 5px;">
                                ...
                                @if ($channel->logo_path)
                                    <label></label>
                                    <img src="{{ Storage::url($channel->logo_path) }}" width="100px"
                                        alt="Current Logo" />
                            ...
                            <div style="margin-bottom: 5px;">
                                ...
                                <textarea class="textarea" name="description" cols="" rows="" maxlength="500">{{ old('description', $channel->description) }}</textarea>
                            ...
                            <div style="margin-bottom: 10px;">
                                ...
                                <input type="number" name="contact_number" class="inputbox_long"
                                    value="{{ old('contact_number', $channel->contact_number) }}" />
                                <div class="sidetxt">* Digits only.</div>
                                <div class="clear"><!-- --></div>
                            </div>
                            <div>
                                <label>&nbsp;</label>
                                <input class="submit_button" value="Update Channel" name="submit" type="submit" />
                                <div style="padding: 5px; margin-left: 225px;"><a
                                        href="{{ url('/create-channel') }}">Cancel</a></div>
                                <div class="clear"><!-- --></div>
                            </div>
                        </form>
